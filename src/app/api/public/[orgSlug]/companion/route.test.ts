  ...
  sponsorshipTiers: [
    {
      id: "tier-supporter",
      monthlyCents: 3250,
      description: "Food and daily care",
      isDefault: false,
    },
    {
      id: "tier-champion",
      monthlyCents: 6000,
      description: "Food, care, and enrichment",
      isDefault: true,
    },
  ],
};
...
test("returns a CORS-aware 404 for an unknown source", async () => {
  const { GET } = createPublicCompanionHandlers(
    dependencies({
