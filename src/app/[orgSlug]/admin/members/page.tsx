...
async function loadMembers(requestHeaders: Headers, orgId: string) {
  const firstPage = await auth.api.listMembers({
    headers: requestHeaders,
    query: { limit: 100, organizationId: orgId, sortBy: "createdAt", sortDirection: "asc" },
  });

  return firstPage.members.length < firstPage.total
    ? auth.api.listMembers({
        headers: requestHeaders,
        query: { limit: firstPage.total, organizationId: orgId, sortBy: "createdAt", sortDirection: "asc" },
      })
    : firstPage;
}
