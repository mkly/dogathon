    ...
    <Html lang="en">
      ...
      >
        <Container style={{ margin: "0 auto", maxWidth: "560px" }}>
          <Section
            style={{
              backgroundColor: transferred ? "#7a8c5e" : "#9a886c",
              borderRadius: "22px",
              color: "#f8f2e7",
              padding: "30px",
            }}
            ...
            {transferred ? (
              <>
                <Text style={{ fontSize: "16px", lineHeight: "1.6" }}>
                  ...
                  {formatMonthlyAmount(input.monthlyCents)} monthly sponsorship
                  with {input.organizationName} continues as usual.
                </Text>
                <Text style={{ fontSize: "16px", lineHeight: "1.6" }}>
              ...
              <Text style={{ fontSize: "16px", lineHeight: "1.6" }}>
                Hi {input.sponsorName}, we have canceled your monthly
                sponsorship with {input.organizationName}. You will not be
                charged again. Thank you for supporting the rescue.
              </Text>
            )}
          </Section>
        </Container>
